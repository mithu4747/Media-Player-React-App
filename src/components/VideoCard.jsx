   ...
   displayData &&
     <Card className='mb-3' draggable onDragStart={(e)=>dragStarted(e,displayData?.id)}>
      ...
      <Card.Body>
        ...
        {insideCategory?"":<button onClick={()=> removeVideo(displayData?.id)} className='btn  text-danger'><i class="fa-solid fa-trash fs-5"></i></button>}
          </Card.Title>      
      </Card.Body>
    </Card>
    }
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe width={"100%"} height={"480px"} src={`${displayData?.embedlink}?autoplay=1`} title={displayData?.caption} 
